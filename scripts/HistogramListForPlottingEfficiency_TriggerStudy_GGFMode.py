...
sIpFiles = OD([
    ...
    ("fIp1", '/eos/cms/store/user/ssawant/htoaa/analysis/20231028_TrigEffiStudy_1/2018/analyze_htoaa_stage1.root')
])
sOpDir  = '/eos/cms/store/user/ssawant/htoaa/analysis/20231028_TrigEffiStudy_1/2018/plots_effi'
...
sampleCategory_MC_forEffiSF_list   = ['TTToSemiLeptonic_powheg', 'MC', 'TT_W']
