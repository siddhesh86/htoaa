...
if __name__ == "__main__":
    ...
    '''
    ipFileName_list = [
        '/eos/cms/store/user/ssawant/htoaa/analysis/20260701_PNetX4bROC/2016preVFP/gg0l/analyze_htoaa_stage1.root',
        '/eos/cms/store/user/ssawant/htoaa/analysis/20260701_PNetX4bROC/2016postVFP/gg0l/analyze_htoaa_stage1.root',
        '/eos/cms/store/user/ssawant/htoaa/analysis/20260701_PNetX4bROC/2017/gg0l/analyze_htoaa_stage1.root',
        '/eos/cms/store/user/ssawant/htoaa/analysis/20260701_PNetX4bROC/2018/gg0l/analyze_htoaa_stage1.root',            
    ]
     '''
    ipFileName_list = [
        '/Users/siddhesh/Work/CMS/htoaa/analysis/20260701_PNetX4bROC/2016preVFP/gg0l/analyze_htoaa_stage1.root',
        '/Users/siddhesh/Work/CMS/htoaa/analysis/20260701_PNetX4bROC/2016postVFP/gg0l/analyze_htoaa_stage1.root',
    ...
    c.SaveAs(opPlotName.replace('.root', '.root'))
    c.SaveAs(opPlotName.replace('.root', '.C'))
    c.SaveAs(opPlotName.replace('.root', '.pdf'))
