...
# Dump actual test code to a SUS-RunIII2024Summer24NanoAODv15-00036_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > SUS-RunIII2024Summer24NanoAODv15-00036_test.sh
#!/bin/bash
...
# cmsDriver command
cmsDriver.py  --scenario pp --era Run3_2024 --customise Configuration/DataProcessing/Utils.addMonitoring --step NANO --conditions 150X_mcRun3_2024_realistic_v2 --datatier NANOAODSIM --eventcontent NANOEDMAODSIM1 --python_filename SUS-RunIII2024Summer24NanoAODv15-00036_1_cfg.py --fileout file:SUS-RunIII2024Summer24NanoAODv15-00036.root --filein "dbs:/GluGluH-01J-HToAATo4B_Par-M-20_TuneCP5_13p6TeV_madgraph-pythia8/RunIII2024Summer24MiniAODv6-150X_mcRun3_2024_realistic_v2-v2/MINIAODSIM" --number 2000 --number_out 2000 --no_exec --mc || exit $? ;

# Run generated config
REPORT_NAME=SUS-RunIII2024Summer24NanoAODv15-00036_report.xml
# Run the cmsRun
cmsRun -e -j $REPORT_NAME SUS-RunIII2024Summer24NanoAODv15-00036_1_cfg.py || exit $? ;

# Parse values from SUS-RunIII2024Summer24NanoAODv15-00036_report.xml report
...
echo "Validation report of SUS-RunIII2024Summer24NanoAODv15-00036 sequence 1/1"
...
# End of SUS-RunIII2024Summer24NanoAODv15-00036_test.sh file
EndOfTestFile

# Make file executable
chmod +x SUS-RunIII2024Summer24NanoAODv15-00036_test.sh
...
singularity run --home $PWD:$PWD /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/SUS-RunIII2024Summer24NanoAODv15-00036_test.sh)
