...
sAnaDir = '/eos/cms/store/user/ssawant/htoaa/analysis/20260212_DataMC'
Dataset = 'Run2'
CAT = 'Vjj'
sAnaVersion = ''
...
sOpDir  = '/eos/cms/store/user/ssawant/htoaa/analysis/20260212_DataMC/%s/%s/plots_ARCCheck1' % (Dataset, CAT)
