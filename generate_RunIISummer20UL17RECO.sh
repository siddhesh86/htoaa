...
# cmsDriver command
#cmsDriver.py  --python_filename HIG-RunIISummer20UL17RECO-01985_1_cfg.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:HIG-RunIISummer20UL17RECO-01985.root --conditions 106X_mc2017_realistic_v6 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:HIG-RunIISummer20UL17HLT-01985.root --era Run2_2017 --runUnscheduled --no_exec --mc -n $EVENTS || exit $? ;

echo "Run cmsDriver.py  --python_filename ${jobName}_1_cfg.py --eventcontent AODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier AODSIM --fileout file:${outputFile} --conditions 106X_mc2017_realistic_v6 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:${inputFile} --era Run2_2017 --runUnscheduled --no_exec --mc -n $EVENTS || exit $? ; "
