...
######################################################################################
# Script to generate SIM sample sourced from
#     https://cms-pdmv.cern.ch/mcm/public/restapi/requests/get_test/HIG-RunIISummer20UL18SIM-02051
######################################################################################
...
# cmsDriver command
# cmsDriver.py  --python_filename HIG-RunIISummer20UL18SIM-02051_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:HIG-RunIISummer20UL18SIM-02051.root --conditions 106X_upgrade2018_realistic_v11_L1v1 --beamspot Realistic25ns13TeVEarly2018Collision --step SIM --geometry DB:Extended --filein file:HIG-RunIISummer20UL18wmLHEGEN-02511.root --era Run2_2018 --runUnscheduled --no_exec --mc -n $EVENTS || exit $? ;

cmsDriver.py  --python_filename ${jobName}_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:${outputFile} --conditions 106X_upgrade2018_realistic_v11_L1v1 --beamspot Realistic25ns13TeVEarly2018Collision --step SIM --geometry DB:Extended --filein file:${inputFile} --era Run2_2018 --runUnscheduled --no_exec --mc -n $EVENTS || exit $? ;
