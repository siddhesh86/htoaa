...
printLevel = 0
nEventToReadInBatch = 1000 # 0.5*10**6 # 2500000 #  1000 # 2500000
nEventsToAnalyze =  1000 # 1000 # 100000 # -1
...
class Processor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        events = events[(
            (events.FatJet_pt[:, 0] > 170.0) )]
        self.output['cutflow']['LeadingFatJetPt > 170'] += len(events)
