...
######################################################################################
# Script to generate HLT sample sourced from
# https://cms-pdmv.cern.ch/mcm/public/restapi/requests/get_test/HIG-RunIISummer20UL18HLT-02051
###################################
...
jobName="SUSY_GluGluH_01J_HToAATo4B_${jobID}_RunIISummer20UL18HLT"

outputDir=$(echo ${outputFile} | sed 's|\(.*\)/.*|\1|')

printf "\n\ngenerate_RunIISummer20ULHLT.sh:: \nArguments: $@ \n"
...
#fi
if [ -r CMSSW_10_2_16_UL/src ] ; then
    echo release CMSSW_10_2_16_UL already exists. Removing it.
...
# cmsDriver command
# cmsDriver.py  --python_filename HIG-RunIISummer20UL18HLT-02051_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --fileout file:HIG-RunIISummer20UL18HLT-02051.root --conditions 102X_upgrade2018_realistic_v15 --customise_commands 'process.source.bypassVersionCheck = cms.untracked.bool(True)' --step HLT:2018v32 --geometry DB:Extended --filein file:HIG-RunIISummer20UL18DIGIPremix-02032.root --era Run2_2018 --no_exec --mc -n $EVENTS || exit $? ;

cmsDriver.py  --python_filename ${jobName}_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --fileout file:${outputFile} --conditions 102X_upgrade2018_realistic_v15 --customise_commands 'process.source.bypassVersionCheck = cms.untracked.bool(True)' --step HLT:2018v32 --geometry DB:Extended --filein file:${inputFile} --era Run2_2018 --no_exec --mc -n $EVENTS || exit $? ;
