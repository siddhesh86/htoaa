...
mkdir -p ../../crab_big_files/CMSSW_10_6_26/ParticleNetAK8/General/V01/
mkdir -p ../../crab_big_files/CMSSW_10_6_26/ParticleNetAK8/MD-2prong/V01/
mkdir -p ../../crab_big_files/CMSSW_10_6_26/ParticleNetAK8/MassRegression/V01/
mv RecoBTag/Combined/data/ParticleNetAK8/General/V01/modelfile ../../crab_big_files/CMSSW_10_6_26/ParticleNetAK8/General/V01/
mv RecoBTag/Combined/data/ParticleNetAK8/MD-2prong/V01/modelfile ../../crab_big_files/CMSSW_10_6_26/ParticleNetAK8/MD-2prong/V01/
mv RecoBTag/Combined/data/ParticleNetAK8/MassRegression/V01/modelfile ../../crab_big_files/CMSSW_10_6_26/ParticleNetAK8/MassRegression/V01/

cd $Dir0

printf "\npwd: $(pwd) \nls:\n $(ls) \n cp CMSSW_10_6_26/src/PhysicsTools/NanoAOD/test/Nano_MC_addHto4bPlus_crab_cfg.py .: \n"; 
