...
######################################################################################
# Script to generate MiniAODv2 sample sourced from
# https://cms-pdmv.cern.ch/mcm/public/restapi/requests/get_test/HIG-RunIISummer20UL18MiniAODv2-02051
######################################################################################
...
jobName="SUSY_GluGluH_01J_HToAATo4B_${jobID}_RunIISummer20UL18MiniAODv2"
...
#fi
if [ -r CMSSW_10_6_20/src ] ; then
    echo release CMSSW_10_6_20 already exists. Removing it.
    rm -rf CMSSW_10_6_20
fi
scram p CMSSW CMSSW_10_6_20
...
# cmsDriver command
# cmsDriver.py  --python_filename HIG-RunIISummer20UL18MiniAODv2-02051_1_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:HIG-RunIISummer20UL18MiniAODv2-02051.root --conditions 106X_upgrade2018_realistic_v16_L1v1 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --filein "dbs:/SUSY_GluGluH_01J_HToAATo4B_Pt150_M-12_TuneCP5_13TeV_madgraph_pythia8/RunIISummer20UL18RECO-106X_upgrade2018_realistic_v11_L1v1-v1/AODSIM" --era Run2_2018 --runUnscheduled --no_exec --mc -n $EVENTS || exit $? ;

cmsDriver.py  --python_filename ${jobName}_1_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:${outputFile} --conditions 106X_upgrade2018_realistic_v16_L1v1 --step PAT --procModifiers run2_miniAOD_UL --geometry DB:Extended --filein file:${inputFile}  --era Run2_2018 --runUnscheduled --no_exec --mc -n $EVENTS || exit $? ;
