...
histograms_dict = OD([
    ...
    ("hLeadingNonHto4bFatJetMass", {sXLabel: r'Mass(W/Z candidate AK8 jet) [GeV]', sYLabel: 'Events', sXRange: [0, 300], sNRebinX: 5}),
    ("hLeadingNonHto4bFatJetMSoftDrop", {sXLabel: r'Mass$_{Soft\, drop}$(W/Z candidate AK8 jet) [GeV]', sYLabel: 'Events', sXRange: [50, 200], sNRebinX: 5 }),
...
histograms_dict  = OD([
    ...
    ("hdPhi_LeadingFJ_LeadingNonHto4bFJ", {sXLabel: 'hdPhi_LeadingFJ_LeadingNonHto4bFJ', sYLabel: 'Events', sXRange: [2.2, 3.14], sNRebinX: 10 }),
    ("hLeadingNonHto4bFatJetPNet_WZvsQCD", {sXLabel: 'hLeadingNonHto4bFatJetPNet_WZvsQCD', sYLabel: 'Events', sXRange: [0.9, 1], sNRebinX: nRebinXTmp_ }),
