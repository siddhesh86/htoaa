...
sLableSig = [
    ...
    #'HToAATo4B_M-55',
    #'ggHtoaato4b_mA_20'
    r'ggH signal mA=15 GeV', #'ggHtoaato4b_mA_15',
    r'ggH signal mA=30 GeV',
    r'ggH signal mA=55 GeV',
]
...
histograms_dict = OD([
    ...
    ("hLeadingFatJetPNet_X4b_v2ab_Haa4b_score", {sXLabel: r'$X\to 4b$ tagger score', sYLabel: 'Events', sXRange: [0.66, 1], sNRebinX: 10 }),
...
histograms_dict = OD([
    #("hLeadingFatJetPt", {sXLabel: 'hLeadingFatJetPt', sYLabel: 'Events', sXRange: [180, 1000], sNRebinX: 4 }),
    ("hLeadingFatJetPNet_34massAa", {sXLabel: r'm(a) version a [GeV]', sYLabel: 'Events', sXRange: [5, 70], sNRebinX: 20}),
    ("hLeadingFatJetPNet_X4b_v2ab_Haa4b_score", {sXLabel: r'$X\to 4b$ tagger score', sYLabel: 'Events', sXRange: [0, 1], sNRebinX: 50 }),
