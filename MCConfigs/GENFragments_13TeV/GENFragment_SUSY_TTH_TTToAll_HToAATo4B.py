...
# link to cards:
# https://github.com/cms-sw/genproductions/pull/2903

INPUTGRIDPACK=""
HIGGSPTMIN=150

externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    #args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/UL/13TeV/madgraph/V5_2.6.5/SUSY_TTH_TTToAll_HToAATo4B_M-12/v1/SUSY_TTH_TTToAll_HToAATo4B_M-12_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
