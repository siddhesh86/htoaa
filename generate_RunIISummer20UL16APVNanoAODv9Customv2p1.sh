...
printf "\n\ngenerate_RunIISummer20UL16APVNanoAODv9Customv2p1.sh:: ${inputFilesList}, ${outputFile}, ${EraYear} \n"

githubUsername=siddhesh86

Dir0=$(pwd)
Dir_CMSSWSrc="/afs/cern.ch/work/s/ssawant/private/htoaa/NanoAODProduction_wPNetHToAATo4B/haa4b_NanoAODv2/r2/CMSSW_10_6_30/src"
