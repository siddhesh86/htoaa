...
printf "\n\ngenerate_RunIISummer20UL16wmLHEGEN.sh:: \nArguments: $@ \n"
printf "\ninputFile: ${inputFile} \n"
...
echo 'pwd (generate_RunIISummer20UL16wmLHEGEN.sh) 0: '
pwd
...
python3.9 -m venv cms_gen_venv_${jobName} && source ./cms_gen_venv_${jobName}/bin/activate
...
#curl -s -k https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_fragment/${jobName} --retry 3 --create-dirs -o Configuration/GenProduction/python/${jobName}-fragment.py
#[ -s Configuration/GenProduction/python/${jobName}-fragment.py ] || exit $?;

echo 'pwd (generate_RunIISummer20UL16wmLHEGEN.sh) 1: '
pwd
echo 'ls (generate_RunIISummer20UL16wmLHEGEN.sh) 1: '
ls
...
echo 'pwd (generate_RunIISummer20UL16wmLHEGEN.sh) 2: '
pwd
echo 'ls (generate_RunIISummer20UL16wmLHEGEN.sh) 2: '
ls
echo 'ls Configuration/GenProduction/python/ (generate_RunIISummer20UL16wmLHEGEN.sh) 2'
ls Configuration/GenProduction/python/

printf "\n\n (generate_RunIISummer20UL16wmLHEGEN.sh) 2: cat Configuration/GenProduction/python/${jobName}-fragment.py: "
...
echo 'pwd (generate_RunIISummer20UL16wmLHEGEN.sh) 3: '
pwd
echo 'ls (generate_RunIISummer20UL16wmLHEGEN.sh) 3: '
ls


# cmsDriver command
#cmsDriver.py Configuration/GenProduction/python/${jobName}-fragment.py --python_filename ${jobName}_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:${jobName}.root --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --customise_commands process.source.numberEventsInLuminosityBlock="cms.untracked.uint32(4000)" --step LHE,GEN --geometry DB:Extended --era Run2_2016_HIPM --no_exec --mc -n $EVENTS || exit $? ;

echo "Run cmsDriver.py Configuration/GenProduction/python/${jobName}-fragment.py --python_filename ${jobName}_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:${outputFile} --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=\"cms.untracked.uint32(${randomSeed})\" --step LHE,GEN --geometry DB:Extended --era Run2_2016_HIPM --no_exec --mc -n $EVENTS || exit $? ;"
cmsDriver.py Configuration/GenProduction/python/${jobName}-fragment.py --python_filename ${jobName}_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN,LHE --fileout file:${outputFile} --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed="cms.untracked.uint32(${randomSeed})" --step LHE,GEN --geometry DB:Extended --era Run2_2016_HIPM --no_exec --mc -n $EVENTS || exit $? ;

echo 'pwd (generate_RunIISummer20UL16wmLHEGEN.sh) 4: '
pwd
echo 'ls (generate_RunIISummer20UL16wmLHEGEN.sh) 4: '
ls
