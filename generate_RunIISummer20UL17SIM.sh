...
printf "\n\ngenerate_RunIISummer20UL17SIM.sh:: \nArguments: $@ \n"
...
# Dump actual test code to a HIG-RunIISummer20UL17SIM-01985_test.sh file that can be run in Singularity
...
# cmsDriver command
#cmsDriver.py  --python_filename HIG-RunIISummer20UL17SIM-01985_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:HIG-RunIISummer20UL17SIM-01985.root --conditions 106X_mc2017_realistic_v6 --beamspot Realistic25ns13TeVEarly2017Collision --step SIM --geometry DB:Extended --filein file:HIG-RunIISummer20UL17wmLHEGEN-02463.root --era Run2_2017 --runUnscheduled --no_exec --mc -n $EVENTS || exit $? ;

echo "Run cmsDriver.py  --python_filename ${jobName}_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:${outputFile} --conditions 106X_mc2017_realistic_v6 --beamspot Realistic25ns13TeVEarly2017Collision --step SIM --geometry DB:Extended --filein file:${inputFile} --era Run2_2017 --runUnscheduled --no_exec --mc -n $EVENTS || exit $? ;"
